...
class ZsvCommandsTest {

    private lateinit var zsvCommands: ZsvCommands
    private val blobFileName = "a3c241ab148df99bc5924738958c3aaad76a322b"
    private val zsvObjectsDirectoryPath = ".zsv/objects"
    ...
    fun testDecompressBlobObject_objectDoesntExist() {
        val result = zsvCommands.decompressBlobObject(true, "a3c241ab148df99bc5924738958c3aaad76a3111")
